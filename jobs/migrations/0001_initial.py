    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary_type', models.CharField(blank=True, choices=[('PH', 'Per Hour'), ('PD', 'Per Day'), ('PW', 'Per Week'), ('PM', 'Per Month'), ('PY', 'Per Year')], default='PM', max_length=2, null=True)),
                ...
                ('work_hour_type', models.CharField(blank=True, choices=[('PD', 'Per Day'), ('PW', 'Per Week'), ('PM', 'Per Month'), ('PY', 'Per Year')], default='PD', max_length=3, null=True)),
